...
function getPatientData($) {
    ...
    patientData = {
        ...
        externalLesion:     getExternalLesion($, constants.HTML_PATIENT_EXTERNAL_LESION),
...
function getExternalLesion($, externalLesionId) {

    var value = getParentField($, externalLesionId);
    return '';
}
